...
export interface BlogPost {
  ...
  /**
   * A pre-made PDF for this article. When present the download button serves
   * this file; when absent it falls back to the browser's print-to-PDF dialog,
   * which the print stylesheet is tuned for.
   */
  pdf?: { url: string; pages: number; size: string };
}
...
export const blogPosts: BlogPost[] = [
  {
    ...
    views: "0",
    featured: true,
    tags: ["Water & Wastewater", "Critical Infrastructure", "Data Diode", "CISA"],
    slug: "take-the-plcs-off-the-internet",
    imageCount: 3,
    level: "Deep dive",
    pdf: {
