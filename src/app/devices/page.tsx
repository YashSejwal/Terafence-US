    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <section
            id="protocols"
            className="py-16 border-t scroll-mt-40"
          >
            <Wrapper>
              <motion.div
                initial={{ opacity: 0, y: 40 }}
          ...
          <section
            id="support"
            className="py-20 border-t scroll-mt-40"
          >
            <Wrapper>
              <motion.div
                ...
                <div className="text-center max-w-3xl mx-auto p-12">
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.97 }}
                      onClick={() =>
                        (window.location.href = "mailto:support@terafence.us")
                      }
                    >
                      GET SUPPORT
          ...
          {/* Final CTA Section */}
          <section className="bg-gradient-to-b from-gray-200 to-blue-300 py-20">
            <Wrapper>
