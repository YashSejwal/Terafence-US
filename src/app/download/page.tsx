        ...
        <Wrapper className="relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12">
            <div className="w-full md:w-3/5 z-10">
              <div className="inline-block mb-4 md:mb-6 bg-gradient-to-r from-blue-600 to-cyan-500 px-4 py-1.5 rounded-full text-sm font-semibold">
              ...
              <p className="text-base sm:text-lg md:text-xl text-slate-200 mb-6 md:mb-8 max-w-2xl leading-relaxed">
              ...
              <div className="flex flex-wrap gap-4">
                <button
                  ...
                  className="px-6 py-3 md:px-8 md:py-4 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-lg font-medium shadow-lg shadow-blue-600/30 hover:shadow-blue-500/40 transition-all duration-300 hover:-translate-y-1"
                >
                  Browse Resources
                </button>
                <a
            ...
            <div className="w-full md:w-2/5 mt-8 md:mt-0 z-10">
              <div className="relative max-w-md mx-auto md:mx-0">
                ...
                <div className="relative bg-gradient-to-br from-[#0e3054] to-[#051b31] p-1 rounded-2xl shadow-2xl">
                  <div className="bg-gradient-to-br from-[#0A2540] to-[#041426] rounded-xl overflow-hidden p-4 md:p-6">
                    <div className="p-3 md:p-4 border-b border-white/10 flex items-center">
                    ...
                    <div className="mt-4 md:mt-6 space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3 md:gap-4 mt-4 md:mt-6">
                        {["Firewall", "SCADA", "ICS", "Endpoint"].map(
                          (item, i) => (
                            <div key={i} className="bg-white/5 p-3 md:p-4 rounded-lg">
                              <div className="w-8 h-8 md:w-10 md:h-10 mb-2 rounded-full bg-gradient-to-br from-blue-500 to-cyan-400 flex items-center justify-center">
        ...
        <Wrapper className="py-16">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8">
            ...
            <div className="flex-1">
              ...
              <div className="bg-white rounded-lg md:rounded-2xl shadow-md md:shadow-lg p-3 md:p-4 mb-6 md:mb-8">
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 md:pl-4 pointer-events-none">
                    <Search className="h-4 w-4 md:h-5 md:w-5 text-[#0A2540]/60" />
                  </div>
                  <input
                    type="text"
                    className="bg-slate-50 border-0 rounded-lg md:rounded-xl pl-10 md:pl-12 p-3 md:p-4 w-full focus:outline-none focus:ring-2 focus:ring-[#0077B6] text-[#0A2540]"
                  ...
                  <div className="mt-3 md:mt-4 flex flex-wrap gap-2">
                    {selectedTypes.map((type) => (
                      <motion.span
                        ...
                        className="inline-flex items-center px-2 md:px-3 py-1 rounded-full text-xs md:text-sm bg-[#0077B6]/10 text-[#0077B6]"
                      >
                        {type}
                        <button
                          onClick={() => toggleType(type)}
                          className="ml-1 md:ml-1.5 rounded-full p-0.5 hover:bg-[#0077B6]/20"
                        >
                    ...
                    {selectedProducts.map((product) => (
                      <motion.span
                        ...
                        animate={{ scale: 1, opacity: 1 }}
                        exit={{ scale: 0.8, opacity: 0 }}
                        className="inline-flex items-center px-2 md:px-3 py-1 rounded-full text-xs md:text-sm bg-[#00B4D8]/10 text-[#00B4D8]"
                      >
                        {product}
                        <button
                          onClick={() => toggleProduct(product)}
                          className="ml-1 md:ml-1.5 rounded-full p-0.5 hover:bg-[#00B4D8]/20"
                        >
                          <X className="h-2 w-2 md:h-3 md:w-3" />
                        </button>
                      </motion.span>
                    ...
                    <motion.button
                      ...
                      className="inline-flex items-center px-2 md:px-3 py-1 rounded-full text-xs md:text-sm bg-slate-200 text-slate-700 hover:bg-slate-300"
                    >
                      Clear All
                    </motion.button>
                  </div>
              ...
              {/* Results count */}
              <p className="text-sm md:text-base text-slate-500 mb-4 md:mb-6 font-medium">
              ...
              >
                ...
                {filteredResources.length === 0 && (
                  ...
                  >
                    <div className="inline-flex justify-center items-center w-12 h-12 md:w-16 md:h-16 rounded-full bg-slate-100 mb-3 md:mb-4">
