    ...
    <div className="relative flex flex-col items-center justify-center w-full py-0">
      ...
      <div className="flex flex-col items-center justify-center gap-y-8 relative">
        ...
        <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-background/0">
          ...
          <Container delay={0.2}>
            <p className="max-w-xl mx-auto mt-2 text-xl lg:text-2xl text-center text-muted-foreground">
              Next-Gen solutions that protect your most vulnerable assets with
              unidirectional data flow technology.
            </p>
          </Container>
          <Container delay={0.25} className="z-20">
            <div className="flex items-center justify-center text-xl mt-6 gap-x-4">
              <Link
          ...
          <Container delay={0.3} className="relative">
            <div className="relative rounded-xl lg:rounded-[32px] border border-border p-2 backdrop-blur-lg mt-10 max-w-6xl mx-auto">
              <div className="absolute top-8 left-10 bg-black/80 backdrop-blur-sm px-4 py-2 rounded-lg border border-border opacity-100">
            ...
            <div className="bg-gradient-to-t from-background to-transparent  inset-x-0 w-full h-1/2 mb-10"></div>
          </Container>
        </div>
      </div>
    </div>
